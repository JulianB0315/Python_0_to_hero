...
> 2. Muestra el diccionario completo.
> 3. Agrega una nueva clave llamada `owner` y asigna un valor.
...
>    - `age`
>    - `city`
> 2. Asigna valores directamente a las claves.
> 3. Muestra el valor de la clave `city`.
> 4. Agrega una nueva clave llamada `phone` con un número de teléfono.
...
> 3. Modifica el valor de `quantity` para agregar 10 unidades más.
> 4. Muestra el precio del producto.
...
> 3. Cambia el valor de `pages` para aumentar en 20.
> 4. Agrega una nueva clave llamada `genre` con un valor.
...
> 3. Agrega una nueva clave llamada `is_healthy` y asigna un valor booleano (`True` o `False`).
...
> 3. Cambia el valor de `phone` por un nuevo número.
> 4. Agrega una nueva clave llamada `address` con una dirección.
> 5. Elimina la clave `email`.
> 6. Muestra el diccionario final.
